...
/////////////////////////////////////////////////////////
 ...
 /////////////////////////////////////////////////////////  
  ...
  $("#wb_element_instance6").mouseover(function(){
	 ...
	 if(!hideFlag)
	 	return false;
	 if(parseInt($(this).css('left'))==609) {
	  	$(this).css('left','409px');
	 }
	 // alert($(this).css('left'));
	  else 
	  	  $(this).css('left','609px');
	  $("#p1").css('color','red').css('font-size','22px').html("כן-כן לחשוב מחוץ לקופסה.<br/><br/>אתם יכולים לעצור את הכפתור?");
	  
	  if(foolcounter>6)
	  	$("#p1").css('color','red').css('font-size','22px').html("לא מספיק להריץ?<br/><br/>טיפ: חפשו בסביבה");
  ...
  //.animate({width:'toggle' },1000);
    ...
    $("#wb_element_instance6").click(function(){
	  if(hideFlag)
	  	return false;
	  if(!seriouse){
	  	$("#p1").css('color','green').css('font-size','22px').html("<br/><br/>מספיק עם המשחקים<br/><br/>");
		seriouse = true;
	  }else{
		  $("#p1").css('color','green').css('font-size','22px').html("<br/><br/>נו באמת<br/><br/>");
		  $("#wb_element_instance6 a").css('cursor','default');
		  $("#wb_element_instance6 a").css('background-color','grey');
		  $("#wb_element_instance6 span").text('עצור');
   ...
   $("#wb_element_instance7").click(function(){
	   if(!hideFlag)
	  	return false;
	  $("#p1").css('color','red').css('font-size','22px').html("גמרתם את הכפתור...<br/><br/>תחפשו יותר טוב");
	  $("#wb_element_instance6").hide();
  });
  ...
  $("#wb_element_instance9").click(function(){
	  if(!hideFlag)
	  	return false;
	  $("#p1").css('color','green').css('font-size','22px').html("כל הכבוד!<br/><br/>");
	  $("#wb_element_instance6").css('left','609px');
	...
	$("#flag2").click(function(){
		...
		window.location.href = window.location.href.replace("heb/","");
	});
	$("#flag3").click(function(){
		...
		//i = i.replace("ru","heb");
	 	//alert(i);	
		window.location.href = window.location.href.replace("heb","ru");
	});
});