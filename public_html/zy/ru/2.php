...
<div class="vbox wb_container" id="wb_main" style="height: 588px; background: transparent none repeat scroll left top; padding: 0 0 40px 0;">
 ...
 <div id="wb_element_instance27" class="wb_element" style="left: 620px; top: 75px; width: 350px; height: 29px; min-width: 290px; min-height: 29px; z-index: 64;  line-height: normal;"><h2 class="wb-stl-heading2">Наши последние проекты</h2>
</div>
...
<h2 class="wb-stl-heading2">Отзывы:</h2>
...
<div id="wb_element_instance22" class="wb_element" style="left: 30px; top: 30px; width: 490px; height: 239px; min-width: 490px; min-height: 239px; z-index: 57; line-height: normal;"><h1 class="wb-stl-heading1">О нас</h1>

<h2 class="wb-stl-heading2"> </h2>

<h2 class="wb-stl-heading2">Более 10 лет в сфере разработки ПО и веб приложений</h2>

<p class="wb-stl-normal"> </p>

<p class="wb-stl-normal" style="font:14px/20px Arial,Helvetica,sans-serif;">Более десяти лет на различных должностях в индустрии разработки WEB дали нам возможность не только приобрести необходимые профессиональные навыки, но и успешно проверить свои способности успешно справляться с любыми трудностями.</p>
