...
error_reporting(E_ALL); ini_set('display_errors', true);
	$pages = array(
		...
		'1'	=> array('id' => '2', 'alias' => 'About-me', 'file' => '2.php'),
		'2'	=> array('id' => '3', 'alias' => 'Contacts', 'file' => '3.php')
	);
	$forms = array(
		'3'	=> array(
			'a2443e76' => Array( 'email' => '', 'subject' => 'Inquiry from the web page', 'sentMessage' => 'Form was sent.', 'fields' => array( array( 'fidx' => '0', 'name' => 'Name', 'type' => 'input', 'options' => '' ), array( 'fidx' => '1', 'name' => 'E-mail', 'type' => 'input', 'options' => '' ), array( 'fidx' => '2', 'name' => 'Message', 'type' => 'textarea', 'options' => '' ) ) )
		)
	);
